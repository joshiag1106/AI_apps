  ...
  return (
    <div className="mx-auto max-w-4xl">
      <div className="text-center">
        <div className="text-[12px] uppercase tracking-[0.22em] text-faint">Plans</div>
      ...
      <div className="mt-8 grid gap-4 sm:grid-cols-2">
        <Panel className="p-5">
          <div className="flex items-baseline justify-between">
            <h2 className="text-[17px] font-semibold text-text">Analyst — Free</h2>
        ...
        <Panel className="relative overflow-hidden border-[color:var(--color-accent-dim)] p-5">
          <div className="flex items-baseline justify-between">
            <h2 className="text-[17px] font-semibold text-text">Desk — Pro</h2>
            {quota.unlimited && <Badge tone="var(--color-accent)" solid>active</Badge>}
          </div>
          <div className="mono-num mt-2 text-3xl">₹2,400<span className="text-[15px] text-faint"> /month</span></div>
          <p className="mt-1 text-[14px] text-muted">Unlimited analysis across every view.</p>
          <ul className="mt-4 space-y-2">
            {PRO.map((f) => (
              <li key={f} className="flex gap-2 text-[15px] text-muted">
          ...
          {quota.unlimited ? (
            <div className="mt-5 rounded-md border border-[color:var(--color-line)] px-4 py-2 text-center text-[15px] text-muted">
              You&apos;re on Pro
            </div>
          ) : mode === 'closed' ? (
            <div className="mt-5 rounded-md border border-[color:var(--color-line)] px-4 py-2 text-center text-[15px] text-muted">
            ...
            <Link href="/login?next=/pricing"
              className="mt-5 block rounded-md bg-[color:var(--color-accent)] px-4 py-2 text-center text-[15px] font-medium text-[#0a0d13] hover:opacity-90">
      ...
      <p className="mx-auto mt-6 max-w-2xl text-center text-[13px] leading-relaxed text-faint">
