...
export default async function EventsPage({ searchParams }: { searchParams: Promise<Record<string, string | undefined>> }) {
  ...
  return (
    <div className="space-y-5">
      <div>
        <div className="text-[12px] uppercase tracking-[0.22em] text-faint">Event feed</div>
      ...
      <Panel className="space-y-3 p-3.5">
        ...
        <div className="flex flex-wrap gap-1.5">
          <span className="mr-1 self-center text-[12px] uppercase tracking-wider text-faint">Domain</span>
          {chip('All', !sp.domain, base({ domain: undefined }))}
          {DOMAINS.map((d) => chip(d, sp.domain === d, base({ domain: d })))}
        </div>

        <div className="flex flex-wrap gap-1.5">
          <span className="mr-1 self-center text-[12px] uppercase tracking-wider text-faint">Language</span>
        ...
        <div className="flex flex-wrap gap-1.5">
          <span className="mr-1 self-center text-[12px] uppercase tracking-wider text-faint">Corroboration</span>
        ...
        <div className="flex flex-wrap gap-1.5">
          <span className="mr-1 self-center text-[12px] uppercase tracking-wider text-faint">Actor</span>
