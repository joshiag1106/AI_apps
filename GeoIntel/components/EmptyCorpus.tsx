...
export function EmptyCorpus() {
  return (
    <div className="panel border-l-2 border-l-[color:var(--color-accent)] p-5">
      <div className="text-[12px] uppercase tracking-[0.2em] text-[color:var(--color-accent)]">
      ...
      <pre className="mono-num mt-3 overflow-x-auto rounded-md border border-[color:var(--color-line)] bg-[color:var(--color-surface)] px-3.5 py-2.5 text-[15px] text-text">
        npm run ingest
      </pre>
