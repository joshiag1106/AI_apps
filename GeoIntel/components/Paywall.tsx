  ...
  return (
    <div className="panel relative overflow-hidden p-8 text-center">
      ...
      <div className="relative">
        <div className="text-[12px] uppercase tracking-[0.2em] text-faint">Free allowance used</div>
        ...
        <div className="mt-5 flex flex-wrap justify-center gap-2.5">
          <Link href="/pricing"
            className="rounded-md bg-[color:var(--color-accent)] px-4 py-2 text-[15px] font-medium text-[#0a0d13] transition-opacity hover:opacity-90">
            See plans
          </Link>
          {kind === 'device' && (
            <Link href="/login"
              className="rounded-md border border-[color:var(--color-line)] px-4 py-2 text-[15px] text-text hover:border-[color:var(--color-accent-dim)]">
              Sign in
            </Link>
          )}
        </div>

        <p className="mx-auto mt-5 max-w-md text-[13px] leading-relaxed text-faint">
