...
export const CONCEPT_GROUPS: ConceptGroup[] = [
  {
    ...
    entries: [
      ...
      { id: 'reprint', term: 'Reprint',
        meaning: 'A report that repeats another’s headline almost word for word, typically wire copy printed by several outlets. Kautilya counts it once: five outlets running one wire story are one original, not five. Only near-identical headlines with the same figures are caught; rewritten or translated copy is not, so the true inflation is somewhat larger than the score removes.' },
      { id: 'confidence', term: 'Confidence',
        meaning: 'A 0–100 score for how well an event is reported, not for how likely it is to be true. It adds six signals — independent originals — a reprinted report counts once (up to 25), ownership mix (20), countries of publication (20), an official statement (15), languages (10) and the record of the best outlet (10) — and takes 10 off for a contradiction.' },
      ...
      { id: 'flag-single-source', term: 'Flag: single source',
        meaning: 'Every report traces back to one original — one outlet, or several printing the same headline. Treat it as a claim, not yet a fact.' },
